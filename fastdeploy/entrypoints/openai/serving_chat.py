...
class OpenAIServingChat:
    ...
    async def chat_completion_stream_generator(
        ...
        if stream_options is None:
            include_usage = envs.STREAM_INCLUDE_USAGE
            include_continuous_usage = False
        else:
            include_usage = stream_options.include_usage or envs.STREAM_INCLUDE_USAGE
        ...
        try:
            ...
            while num_choices > 0:
                ...
                async for res in generator:
                    ...
                    if request.collect_metrics or envs.COLLECT_METRICS:
    ...
    async def chat_completion_full_generator(
        ...
        res = ChatCompletionResponse(
            ...
            choices=choices,
            usage=usage,
            metrics=last_metrics[0] if request.collect_metrics or envs.COLLECT_METRICS else None,
        )
