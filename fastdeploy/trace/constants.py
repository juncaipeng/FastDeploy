...
class LoggingEventName(Enum):
    ...
    # For Decode Instance
    DECODE_PROCESS_PREALLOCAT_REQUEST_START = "DECODE_PROCESS_PREALLOCAT_REQUEST_START"
...
EVENT_TO_STAGE_MAP = {
    ...
    LoggingEventName.DECODE_PROCESS_PREALLOCAT_REQUEST_START: StageName.DECODE,
